...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER : 🔥Khaled-tachach🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m FACEBOOK  :   Khaled-tachach
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<3:
					...
					pwv.append(frs+'123')
					pwv.append(frs+'nmf')
					pwv.append(frs+'nmf123')
					pwv.append(frs+'nmf1234')
					pwv.append(frs+'nmf12345')
					pwv.append(frs+' 123')
					pwv.append(frs+' 1234')
					pwv.append(frs+' 12345')
					pwv.append(frs+'2021')
